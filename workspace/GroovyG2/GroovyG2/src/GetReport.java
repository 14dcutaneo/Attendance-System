		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) 
			{
				...
				try {
					...
					if (buttState == 3)
						addon += "late, unexcused students";
					if (buttState == 4)
						addon += "present students";
					if (buttState == 5)
						addon += "late, excused students";
					if (buttState == 7)
	...
	String[] s = e.beautify();
		...
		button_1.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent ae) 
			{
				...
				// 2 = Present
				// 3 = Late
				PrintServ.print("ONE!!" + list.getSelectedIndex());
				PrintServ.print("TWO!! " + e.beautify()[list.getSelectedIndex()]);
				lastSelect = list.getSelectedIndex();
				PrintServ.print("THREE!! ID SELECTED:::::::: "+ e.getMarkerFromString(
										
						list.getSelectedItem()
										
										).id +" wtf: " + list.getSelectedItem());
			...
			if (buttState == 0)
				...
				if (buttState == 1 && str.endsWith("Absent (Unexcused)"))
					...
					if (buttState == 2 && str.endsWith("Absent (Excused)"))
						...
						if (buttState == 3 && str.endsWith("Late (Unexcused)"))
							list.add(str);
						else
							if (buttState == 4 && str.endsWith("Present"))
								...
								if (buttState ==7)
								{
									...
									if (buttState == 5 && str.endsWith("Late (Excused)"))
									list.add(str);
			
		}
		PrintServ.print("Here! Is : " + lastSelect);
				if (lastSelect != 0)
				{
					list.select(lastSelect);
					PrintServ.print("Here! Is : " + lastSelect);
					lastSelect = 0;
				}
	}
